...
int main() {
    ...
    int beans_availability = 56;
    int water_availability = 280;
    int milk_availability = 1120;
    int syrup_availability = 210;
        ...
        if (option == 1) {
            ...
            while (1) {
                ...
                if (totalpayment >= price) {
                    ...
                    water_availability -= (coffee == 1) ? 30 : (coffee == 2) ? 30 : 39;
                    if (coffee == 2) milk_availability -= 70;
                    if (coffee == 3) {
                        milk_availability -= 160;
                        syrup_availability -= 30;
                    }
                    if (beans_availability <= 10) printf("Warning: Low beans!\n");
                    if (water_availability <= 50) printf("Warning: Low water!\n");
                    if (milk_availability <= 100) printf("Warning: Low milk!\n");
                    if (syrup_availability <= 20) printf("Warning: Low syrup!\n");
                }
            }
        } else if (option == 2) {
            int password;
                ...
                if (password == adminpass) {
                    ...
                    while (1) {
                        ...
                        if (admin_option == 1) {
                            ...
                            beans_availability = 56;
                            water_availability = 280;
                            milk_availability = 1120;
                            syrup_availability = 210;
